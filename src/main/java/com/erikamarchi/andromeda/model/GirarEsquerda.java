...
//
//public class GirarEsquerda implements ComandoMovimentacao {
//    @Override
...
//
//        Coordenada coordenada = new Coordenada(x.intValue(), y.intValue());
//
//        Sentido novoSentido = localizacao.getSentido().girarAEsquerda();
//
//        return new Localizacao(coordenada, novoSentido);
//    }
//}
